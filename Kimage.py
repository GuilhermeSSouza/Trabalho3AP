...
def rgb2hex(rgb):
    hex = (int(rgb[0]), int(rgb[1]), int(rgb[2])) #"#{:02x}{:02x}{:02x}".format(int(rgb[0]), int(rgb[1]), int(rgb[2]))
    return hex
...
plot_image_info('/home/arcano/Área de Trabalho/Maquinas/AGenetico/Images/images(2)')
